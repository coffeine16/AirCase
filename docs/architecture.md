...
**Thesis:** India does not have a monitoring problem; it has an action problem. Over 900 CAAQMS stations exist, and the *money* exists too — it is the action that does not. A CAG performance audit tabled in the Delhi Assembly found **₹843.12 crore of the ₹1,624.63 crore collected as Environment Compensation Charge (2015-16 to 2024-25) still unspent**, with collection records missing for **280 days** and no explanation offered when CAG asked for one. The same pattern holds nationally: of the 15th Finance Commission's air quality grant, **₹8,357.63 crore was released to 42 million-plus cities and only ₹5,465.49 crore utilised** — and Bengaluru, released ₹535.10 crore, utilised **₹0.00** (PIB/Lok Sabha, 5 Feb 2024, Annexure-I). Cities are not short of monitors or of budget; they are short of a defensible answer to *where to act*. CAG has named that exact gap in a formal audit — Report No. 2 of 2022 carries a section headed **"Lack of real-time information regarding sources of pollutants"**, which states: *"AQI values only indicate the total concentration of pollutants in an area. The source of each pollutant is measured by source apportionment/emission inventory study."* Delhi paid ₹87.60 lakh for such a study, terminated the contract in December 2020, and had **not finalised any study as of March 2021**. The same audit found the monitors themselves compromised — *"the location of CAAQMSs did not fulfill the requirements laid down by the CPCB, indicating possible inaccuracies in the data generated by these CAAQMSs, rendering the AQI values unreliable"* — and concluded that without source information, *"impact and success of any measure to control pollution cannot be assessed."* **That study is what this platform produces continuously, from free public data.** The platform closes the loop from signal to intervention, and treats a second, quieter problem as a first-class design constraint: **every civic dataset lies about coverage**. Station maps are biased toward where monitors happen to sit; citizen complaints are biased toward who is online and literate. It corrects both before ranking anything.
